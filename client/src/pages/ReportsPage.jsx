...
export default function ReportsPage({ reports }) {
  ...
  return (
    <>
      ...
      <section className="stats report-stats"><div className="stat"><b>{reports.totalDocuments}</b><span>Total Documents</span></div><div className="stat"><b>{reports.totalSummaries}</b><span>Client Summaries</span></div><div className="stat"><b>{reports.unreadNotifications}</b><span>Unread Notifications</span></div></section>
